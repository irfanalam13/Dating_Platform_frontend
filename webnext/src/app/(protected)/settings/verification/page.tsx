    ...
    <main className="min-h-[100dvh] px-4 py-5 text-[#2D2424]">
      <div className="mx-auto max-w-md">
        <header className="mb-5 flex items-center gap-3">
          <button onClick={() => router.push("/settings")} className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-white/80 bg-white/85 text-[#1a1a2e] shadow-[0_4px_12px_rgba(16,24,40,0.08)]" aria-label="Back">
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/80 px-4">
          <div className="w-full max-w-sm rounded-2xl bg-white p-4">
            ...
            <div className="mt-3 flex gap-2">
              ...
              <button
                onClick={capture}
                className="glass-btn-rose flex-1 rounded-xl py-2 text-sm font-semibold"
              >
                Capture
              </button>
            </div>
