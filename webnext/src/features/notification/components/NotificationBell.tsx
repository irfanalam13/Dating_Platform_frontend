...
//       {open && (
//         <div className="absolute right-0 top-12 w-80 rounded-2xl shadow-xl border // border-gray-200 dark:border-gray-700 // overflow-hidden z-50">
...
//             ) : (
//               notifications.map((n) => (
//                 <div key={n.id} className={`px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 // transition-colors ${!n.is_read ? 'bg-indigo-50/50 dark:bg-indigo-950/30' : ''}`}>
