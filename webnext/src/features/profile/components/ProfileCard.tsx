...
//   function getAvatarColor(name?: string | null): { bg: string; text: string } {
...
//             ) : (
//               <div
//                 className="w-full h-full rounded-full border-4 border-rose-100 flex items-center justify-center text-4xl font-semibold"
//                 style={{ background: getAvatarColor(profile.full_name).bg, color: getAvatarColor(profile.full_name).text }}
//               >
