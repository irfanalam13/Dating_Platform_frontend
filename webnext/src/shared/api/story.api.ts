...
import type { Story, StoryGroup, StoryViewers } from "@/shared/types/story.types";
...
/** GET /chat/stories/:uuid/viewers/ — who has seen your own story. */
export function getStoryViewers(storyUuid: string): Promise<StoryViewers> {
