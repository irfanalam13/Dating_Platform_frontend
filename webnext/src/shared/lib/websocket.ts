...
// // ─────────────────────────────────────────────────────────
// // Base manager — handles connect, reconnect, ping, send
// // ─────────────────────────────────────────────────────────
...
//   protected _scheduleReconnect(token: string) {
...
// // ─────────────────────────────────────────────────────────
// // Chat WebSocket — one per conversation
// // ─────────────────────────────────────────────────────────
...
// // ─────────────────────────────────────────────────────────
// // Notification WebSocket — global, one per session
// // ─────────────────────────────────────────────────────────
...
class WebSocketManager {
  ...
  connect(token: string) {
    ...
    this.shouldReconnect = true;
    this.status = "connecting";
    this._token = token;  // ✅ store token for reconnect
    ...
    // ✅ Assign handlers IMMEDIATELY after creating — before any async events
    this.ws.onopen = () => {
...
export class ChatWebSocket extends WebSocketManager {
  ...
  // 👇 no longer override connect() — just override _onMessage()
