...
import { usePathname } from "next/navigation";
import { Bell, HeartHandshake, Home, MessageCircle, Settings, UserRound } from "lucide-react";
import { NotificationProvider } from "@/features/notification/context/NotificationContext"; // 👈 add this
...
export function MvpShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <NotificationProvider>
      {/* 👇 add pb-16 when nav is visible so content isn't hidden behind it */}
